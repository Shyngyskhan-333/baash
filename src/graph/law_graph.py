"""
Построение и визуализация графа связей между законами.
Nodes = законы, Edges = ссылки + найденные проблемы.
"""
...
EDGE_COLORS = {
    "reference":     "#4a9eff",   # синий — явная ссылка
    "duplicate":     "#ffd700",   # жёлтый — дубль
    "contradiction": "#ff4444",   # красный — противоречие
    "outdated":      "#ff8c00",   # оранжевый — устаревшая
}

NODE_OK      = "#6c63ff"   # фиолетовый — нет проблем
NODE_WARNING = "#ff8c00"   # оранжевый — есть проблемы
NODE_DANGER  = "#ff4444"   # красный — много проблем
